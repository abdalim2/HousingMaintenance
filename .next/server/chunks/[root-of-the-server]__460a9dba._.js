...
async function GET() {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc('version');
        if (error) {
...
async function runSetupDBScript() {
    return new Promise((resolve)=>{
        // تحديد مسار سكريبت الإعداد
        const scriptPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), 'scripts/setup-db-supabase.js');
        // تنفيذ السكريبت باستخدام Node.js
        const child = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])('node', [
            scriptPath
        ]);
        let output = '';
        let errorOutput = '';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__460a9dba._.js.map