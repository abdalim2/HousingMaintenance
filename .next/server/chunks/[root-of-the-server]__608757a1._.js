...
"[project]/.next-internal/server/app/api/housing/facilities/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/housing/facilities/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Build query
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('facilities').select('*');
        // Add filters
        if (complexId) {
...
async function POST(request) {
    try {
        ...
        // Insert facility
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('facilities').insert(facility).select().single();
        if (error) {
...
async function PUT(request) {
    try {
        ...
        // Update facility
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('facilities').update(facilityData).eq('id', id).select().single();
        if (error) {
...
async function DELETE(request) {
    try {
        ...
        // Delete facility
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('facilities').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__608757a1._.js.map