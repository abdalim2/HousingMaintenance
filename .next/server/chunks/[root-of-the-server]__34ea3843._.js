...
async function POST(request) {
    try {
        ...
        // Build INSERT query
        const sqlQuery = `INSERT INTO facilities (${fields.join(', ')}) 
       VALUES (${placeholders})
       RETURNING *`;
...
async function PUT(request) {
    try {
        ...
        const values = [
            id,
            ...fields.map((field)=>facilityData[field])
        ];
        // Build UPDATE query
        const sqlQuery = `UPDATE facilities 
       SET ${setClause}
       WHERE id = $1
       RETURNING *`;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sqlQuery, values);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34ea3843._.js.map