...
const getMaintenanceRequestById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_requests WHERE id = $1', [
            id
        ]);
...
const deleteMaintenanceRequest = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('DELETE FROM maintenance_requests WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getMaintenanceItems = async (maintenanceId)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_items WHERE maintenance_id = $1', [
            maintenanceId
        ]);
        return result.rows || [];
    } catch (err) {
...
const getMaintenanceItemById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_items WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteMaintenanceItem = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('DELETE FROM maintenance_items WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getMonthlyMaintenanceRequests = async (year, month)=>{
    ...
    `;
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeQuery"])(sql, [
            startDate,
            endDate
        ], []);
    } catch (err) {
...
const getCategories = async ()=>{
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeQuery"])('SELECT * FROM categories', [], []);
    } catch (err) {
...
const getCategoryById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM categories WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteCategory = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('DELETE FROM categories WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getItems = async (categoryId)=>{
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(sql, params);
        return result.rows || [];
    } catch (err) {
...
const getItemById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM items WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteItem = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('DELETE FROM items WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getInventory = async (itemId)=>{
    ...
    `;
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeQuery"])(sql, params, []);
...
const updateInventoryQuantity = async (itemId, quantityChange)=>{
    try {
        ...
        const currentInventoryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM inventory WHERE item_id = $1', [
            itemId
        ]);
        ...
        if (currentInventory) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('UPDATE inventory SET quantity = $1, last_updated = $2 WHERE id = $3 RETURNING *', [
                newQuantity,
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])('INSERT INTO inventory (item_id, quantity, last_updated) VALUES ($1, $2, $3) RETURNING *', [
                itemId,
                quantityChange,
                new Date().toISOString()
            ]);
...
const updateInventoryItem = async (id, updates)=>{
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(`UPDATE inventory SET ${setClause} WHERE id = $${fields.length + 1} RETURNING *`, values);
        return result.rows[0];
    } catch (err) {
...
const getLowStockItems = async (threshold = 10)=>{
    try {
      ...
      WHERE i.quantity <= $1
    `;
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["safeQuery"])(sql, [
            threshold
        ], []);
        // Format the result to match the expected structure
        return rows.map((row)=>({
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__,
...
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$purchaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
"use client";
;
;
;
        ...
        const fetchDashboardData = async ()=>{
            ...
            try {
                ...
                const [pendingResult, inProgressResult, lowStockResult, ordersResult] = await Promise.allSettled([
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMaintenanceRequests"])(undefined, undefined, 'pending').catch(()=>[]),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMaintenanceRequests"])(undefined, undefined, 'in_progress').catch(()=>[]),
                    // Get low stock items (threshold of 5)
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLowStockItems"])(5).catch(()=>[]),
                    // Get recent purchase orders (limit to 5)
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$purchaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPurchaseOrders"])().catch(()=>[])
                ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2587e6d3._.js.map