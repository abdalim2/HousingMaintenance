...
"[project]/src/app/inventory/categories/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CategoriesPage() {
    ...
    const [itemCounts, setItemCounts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    // Form state
    ...
    const loadCategories = async ()=>{
        ...
        setError(null);
        try {
            const categoriesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCategories"])();
            setCategories(categoriesData);
            // Get item counts per category
            const counts = {};
            for (const category of categoriesData){
                const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getItems"])(category.id);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (isEditing && categoryId) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCategory"])(categoryId, {
                    name,
                ...
                // Create new category
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCategory"])({
                    name,
                    description: description || undefined
                });
    ...
    const handleDelete = async (categoryId)=>{
        ...
        setSuccess(null);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteCategory"])(categoryId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6ccd141._.js.map