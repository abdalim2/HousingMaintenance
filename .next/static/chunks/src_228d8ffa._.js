...
const checkMaintenanceTablesExist = async ()=>{
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('maintenance_requests').select('id').limit(1);
        if (error) {
...
const checkPurchaseTablesExist = async ()=>{
    try {
        // Try to get just one record to check if the table exists
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('purchase_orders').select('id').limit(1);
        if (error) {
            if (error.message.includes('does not exist')) {
                return {
                    exists: false,
...
const checkPurchaseItemsTableExists = async ()=>{
    try {
        // Try to get just one record to check if the table exists
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('purchase_items').select('id').limit(1);
        if (error) {
            if (error.message.includes('does not exist')) {
                return {
                    exists: false,
...
"[project]/src/lib/AppDataContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AppDataContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
...
function AppDataProvider({ children }) {
    ...
    const refreshData = async ()=>{
        ...
        try {
            ...
            try {
                const orders = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$purchaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPurchaseOrders"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppDataProvider.useEffect": ()=>{
            ...
            const intervalId = setInterval({
                "AppDataProvider.useEffect.intervalId": ()=>{
                    refreshData();
                }
            }["AppDataProvider.useEffect.intervalId"], 5 * 60 * 1000);
            return ({
                "AppDataProvider.useEffect": ()=>clearInterval(intervalId)
            })["AppDataProvider.useEffect"];
        }
    }["AppDataProvider.useEffect"], []);
...
_s(AppDataProvider, "k9TFv7N7bqbViHIc54UDjkY92Tg=");
_c = AppDataProvider;
function useAppData() {
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AppDataContext);
}
_s1(useAppData, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/client/app-dir/link.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AppDataContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/AppDataContext.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function SideInfo() {
    ...
    const { pendingMaintenanceCount, lowStockItems, recentOrders, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AppDataContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppData"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SideInfo.useEffect": ()=>{
            // تحديث التاريخ والوقت كل دقيقة
            const intervalId = setInterval({
                "SideInfo.useEffect.intervalId": ()=>{
                    setCurrentDate(new Date());
                }
            }["SideInfo.useEffect.intervalId"], 60000);
            return ({
                "SideInfo.useEffect": ()=>clearInterval(intervalId)
            })["SideInfo.useEffect"];
        }
    }["SideInfo.useEffect"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            !loading && lowStockItems.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "card p-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-xl font-bold mb-3 flex justify-between items-center",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            lowStockItems.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            !loading && recentOrders.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "card p-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-xl font-bold mb-3 flex justify-between items-center",
...
_s(SideInfo, "MocClo6ytoMzn7UNu9irEvky/0E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AppDataContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppData"]
    ];
});
_c = SideInfo;
var _c;
...
"[project]/src/components/PageTransitionProgress.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PageTransitionProgress() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageTransitionProgress.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageTransitionProgress.useEffect": ()=>{
            ...
            const handleRouteChangeStart = {
                "PageTransitionProgress.useEffect.handleRouteChangeStart": ()=>{
            ...
            const handleRouteChangeComplete = {
                "PageTransitionProgress.useEffect.handleRouteChangeComplete": ()=>{
                    setIsNavigating(false);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nprogress$2f$nprogress$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].done();
                }
            }["PageTransitionProgress.useEffect.handleRouteChangeComplete"];
            ...
            const handleRouteChangeError = {
                "PageTransitionProgress.useEffect.handleRouteChangeError": ()=>{
                    setIsNavigating(false);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nprogress$2f$nprogress$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].done();
                }
            }["PageTransitionProgress.useEffect.handleRouteChangeError"];
...
_s(PageTransitionProgress, "uZcp9WA5Z3k3Y5ZO0gMZgcrpk2g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c = PageTransitionProgress;
var _c;
__turbopack_context__.k.register(_c, "PageTransitionProgress");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_228d8ffa._.js.map