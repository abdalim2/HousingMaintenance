...
"[project]/src/lib/neondb.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/neondb.ts [app-client] (ecmascript)");
;
const getMaintenanceRequests = async (complexId, buildingId, status)=>{
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeQuery"])(sql, params, []);
    } catch (err) {
...
const getMaintenanceRequestById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_requests WHERE id = $1', [
            id
        ]);
...
const createMaintenanceRequest = async (request)=>{
    try {
      ...
      RETURNING *
    `;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(sql, values);
...
const deleteMaintenanceRequest = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM maintenance_requests WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getMaintenanceItems = async (maintenanceId)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_items WHERE maintenance_id = $1', [
            maintenanceId
        ]);
        return result.rows || [];
    } catch (err) {
...
const getMaintenanceItemById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM maintenance_items WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteMaintenanceItem = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM maintenance_items WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getMonthlyMaintenanceRequests = async (year, month)=>{
    ...
    `;
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeQuery"])(sql, [
            startDate,
            endDate
        ], []);
    } catch (err) {
...
const getCategories = async ()=>{
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeQuery"])('SELECT * FROM categories', [], []);
    } catch (err) {
...
const getCategoryById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM categories WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteCategory = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM categories WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getItems = async (categoryId)=>{
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(sql, params);
        return result.rows || [];
    } catch (err) {
...
const getItemById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM items WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deleteItem = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM items WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const getInventory = async (itemId)=>{
    ...
    `;
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeQuery"])(sql, params, []);
...
const getInventoryItemById = async (id)=>{
    try {
      ...
      WHERE i.id = $1
    `;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(sql, [
            id
        ]);
...
const updateInventoryQuantity = async (itemId, quantityChange)=>{
    try {
        ...
        const currentInventoryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM inventory WHERE item_id = $1', [
            itemId
        ]);
        ...
        if (currentInventory) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('UPDATE inventory SET quantity = $1, last_updated = $2 WHERE id = $3 RETURNING *', [
                newQuantity,
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('INSERT INTO inventory (item_id, quantity, last_updated) VALUES ($1, $2, $3) RETURNING *', [
                itemId,
                quantityChange,
                new Date().toISOString()
            ]);
...
const updateInventoryItem = async (id, updates)=>{
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(`UPDATE inventory SET ${setClause} WHERE id = $${fields.length + 1} RETURNING *`, values);
        return result.rows[0];
    } catch (err) {
...
const getLowStockItems = async (threshold = 10)=>{
    try {
      ...
      WHERE i.quantity <= $1
    `;
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeQuery"])(sql, [
            threshold
        ], []);
        // Format the result to match the expected structure
        return rows.map((row)=>({
...
const getPurchaseOrderById = async (id)=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM purchase_orders WHERE id = $1', [
            id
        ]);
        return result.rows[0] || null;
    } catch (err) {
...
const deletePurchaseOrder = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM purchase_orders WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const deletePurchaseItem = async (id)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('DELETE FROM purchase_items WHERE id = $1', [
            id
        ]);
    } catch (err) {
...
const generateMonthlyPurchaseOrder = async (year, month, createdBy)=>{
    try {
        ...
        let result;
        try {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM maintenance_requests WHERE reported_date >= $1 AND reported_date <= $2', [
                startDate,
                endDate
            ]);
        } catch (err) {
        ...
        let itemsResult;
        try {
            itemsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(`SELECT * FROM maintenance_items WHERE maintenance_id IN (${placeholders})`, maintenanceIds);
        } catch (err) {
            // If the table doesn't exist, create a purchase order without items
            if (err.message.includes('does not exist')) {
        ...
        const orderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO purchase_orders (${orderFields}) VALUES (${orderPlaceholders}) RETURNING *`, orderValues);
        ...
        if (Object.keys(itemQuantities).length > 0) {
            ...
            for (const item of purchaseItems){
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO purchase_items (${itemFields}) VALUES (${itemPlaceholders})`, itemValues);
            }
        }
...
const createEmptyPurchaseOrder = async (year, month, createdBy)=>{
    ...
    const placeholders = Object.keys(newOrder).map((_, i)=>`$${i + 1}`).join(', ');
    const values = Object.values(newOrder);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO purchase_orders (${fields}) VALUES (${placeholders}) RETURNING *`, values);
    return result.rows[0];
};
const processReceivedItems = async (purchaseOrderId, receivedItems)=>{
    try {
        ...
        for (const item of receivedItems){
            ...
            const updateItemResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('UPDATE purchase_items SET received_quantity = $1 WHERE id = $2 RETURNING *', [
            ...
            const inventoryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM inventory WHERE item_id = $1', [
                purchaseItem.item_id
            ]);
            const currentInventory = inventoryResult.rows[0];
            // If inventory entry exists, update it
            if (currentInventory) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('UPDATE inventory SET quantity = $1, last_updated = $2 WHERE id = $3', [
                    currentInventory.quantity + item.received_quantity,
                    new Date().toISOString(),
                    currentInventory.id
                ]);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('INSERT INTO inventory (item_id, quantity, unit_price, last_updated) VALUES ($1, $2, $3, $4)', [
                    purchaseItem.item_id,
                    item.received_quantity,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$neondb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])('UPDATE purchase_orders SET status = $1 WHERE id = $2', [
            'received',
            purchaseOrderId
        ]);
    } catch (err) {
...
//# sourceMappingURL=src_d9534ff1._.js.map