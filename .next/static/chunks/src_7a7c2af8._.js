...
"[project]/src/app/maintenance/new/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NewMaintenanceRequestPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewMaintenanceRequestPage.useEffect": ()=>{
            const fetchInitialData = {
                "NewMaintenanceRequestPage.useEffect.fetchInitialData": async ()=>{
                    setIsLoading(true);
                    try {
                        ...
                        let itemsData = [];
                        try {
                            complexesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$housingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getComplexes"])();
                        } catch (complexError) {
                            console.error('Error fetching complexes:', complexError);
                        }
                        try {
                            itemsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getItems"])();
                        } catch (itemsError) {
            ...
            }["NewMaintenanceRequestPage.useEffect.fetchInitialData"];
            fetchInitialData();
        }
    }["NewMaintenanceRequestPage.useEffect"], []);
        ...
        "NewMaintenanceRequestPage.useEffect": ()=>{
            if (formData.complex_id) {
                const fetchBuildings = {
                    "NewMaintenanceRequestPage.useEffect.fetchBuildings": async ()=>{
                        try {
                            const buildingsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$housingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBuildings"])(formData.complex_id);
                            setBuildings(buildingsData);
                            // Reset dependent fields
                            setFormData({
                                "NewMaintenanceRequestPage.useEffect.fetchBuildings": (prev)=>({
                                        ...prev,
                                        building_id: '',
                                        room_id: '',
                                        facility_id: ''
                                    })
                            }["NewMaintenanceRequestPage.useEffect.fetchBuildings"]);
                            setRooms([]);
                            setFacilities([]);
                        } catch (err) {
        ...
        "NewMaintenanceRequestPage.useEffect": ()=>{
            if (formData.building_id) {
                const fetchRoomsAndFacilities = {
                    "NewMaintenanceRequestPage.useEffect.fetchRoomsAndFacilities": async ()=>{
                        try {
                            const [roomsData, facilitiesData] = await Promise.all([
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$housingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRooms"])(formData.building_id),
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$housingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFacilities"])(formData.complex_id, formData.building_id)
                            ]);
                            setRooms(roomsData);
                            setFacilities(facilitiesData);
                            // Reset dependent fields
                            setFormData({
                                "NewMaintenanceRequestPage.useEffect.fetchRoomsAndFacilities": (prev)=>({
                                        ...prev,
                                        room_id: '',
                                        facility_id: ''
                                    })
                            }["NewMaintenanceRequestPage.useEffect.fetchRoomsAndFacilities"]);
                        } catch (err) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const maintenanceRequest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMaintenanceRequest"])({
            ...
            const itemPromises = selectedItems.map((item)=>{
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$maintenanceService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMaintenanceItem"])({
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: [
                                            ...
                                            facilities.map((facility)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: facility.id,
                                                    children: [
                                                        facility.name,
                                                        " (",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            selectedItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                className: "space-y-4",
                                children: selectedItems.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            allItems.map((itemOption)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: itemOption.id,
...
_s(NewMaintenanceRequestPage, "uF9bfmMqgcCd8WJpZ1fQU5+92Pc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = NewMaintenanceRequestPage;
var _c;
__turbopack_context__.k.register(_c, "NewMaintenanceRequestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_7a7c2af8._.js.map