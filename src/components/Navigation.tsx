...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Sidebar Navigation */}
      <aside
        className={`z-30 bg-primary text-white w-64 fixed inset-y-0 right-0 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${
          isOpen ? 'translate-x-0' : 'translate-x-full'
        } flex flex-col justify-between`}
      >
        <div>
          <div className="p-6 border-b border-primary-700">
            <h1 className="text-xl font-bold">نظام إدارة الصيانة</h1>
          </div>
