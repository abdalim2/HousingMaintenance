  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="bg-white shadow-md rounded-lg p-4 mb-8">
        <h2 className="text-lg font-semibold mb-4">الفترة الزمنية</h2>
        <div className="flex gap-4">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md ${timeframe === 'quarter' 
              ? 'bg-primary text-white' 
              : 'bg-gray-100 hover:bg-gray-200'}`}
          >
            ربع سنوي
        ...
        <>
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div className="bg-primary/5 p-4 border-b border-primary/20">
              <div className="flex justify-between items-center">
                <h2 className="text-lg font-semibold">إحصائيات طلبات الصيانة</h2>
                <Link href="/reports/maintenance" className="text-primary hover:underline">
                  عرض التقرير المفصل
                </Link>
              </div>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div className="text-center p-4 bg-yellow-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">{maintenanceStats.pending}</p>
                </div>
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">{maintenanceStats.completed}</p>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">معدل الإنجاز</p>
                  <p className="text-2xl font-bold">{maintenanceStats.completionRate}%</p>
                </div>
                <div className="text-center p-4 bg-indigo-50 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">متوسط مدة الإنجاز</p>
                  <p className="text-2xl font-bold">{maintenanceStats.averageCompletionDays} يوم</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <div className="bg-secondary/5 p-4 border-b border-secondary/20">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg font-semibold">حالة المخزون</h2>
                  <Link href="/inventory" className="text-secondary hover:underline">
                    إدارة المخزون
                  </Link>
                </div>
              </div>
              <div className="p-6">
                <div className="mb-6">
                  <div className="flex justify-between mb-2">
                    <h3 className="font-medium">الأصناف منخفضة المخزون</h3>
                    ...
                    <ul className="divide-y">
                      {inventoryStats.lowStockItems.slice(0, 5).map(item => (
                        <li key={item.id} className="py-2 flex justify-between">
                          ...
                          <span className="font-bold text-red-600">{item.quantity} {item.items.unit}</span>
                        </li>
                      ))}
                      {inventoryStats.lowStockItems.length > 5 && (
                        <li className="py-2 text-center text-primary hover:underline">
                ...
                <Link href="/inventory/report" className="btn btn-secondary w-full">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <div className="bg-accent/5 p-4 border-b border-accent/20">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg font-semibold">حالة المشتريات</h2>
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{purchaseStats.totalAmount.toLocaleString()} ريال</p>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <p className="text-sm text-gray-500 mb-1">قيد الإجراء</p>
                    <p className="text-2xl font-bold">{purchaseStats.pending}</p>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-gray-500 mb-1">مكتملة</p>
                    <p className="text-2xl font-bold">{purchaseStats.completed}</p>
                  </div>
                </div>
                
                <Link href="/reports/purchases" className="btn bg-accent hover:bg-accent/90 w-full">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div className="p-4 border-b">
              <h2 className="text-lg font-semibold">التقارير الشهرية</h2>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Link 
                  href={`/reports/monthly/${currentYear}/${currentMonth + 1}/maintenance`}
                  className="p-4 border rounded-lg bg-gray-50 hover:bg-gray-100 flex flex-col items-center"
                >
                  ...
                  <span className="text-center font-medium">تقرير الصيانة الشهري</span>
                </Link>
                ...
                >
                  ...
                  <span className="text-center font-medium">تقرير حركة المخزون</span>
                </Link>
                ...
                >
                  ...
                  <span className="text-center font-medium">تقرير المشتريات الشهري</span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <div className="p-4 border-b">
              <h2 className="text-lg font-semibold">تصدير التقارير</h2>
            </div>
            <div className="p-6">
